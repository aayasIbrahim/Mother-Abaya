...
const Navbar = () => {
  ...
  // ব্রাউজারে ডাটা লোড না হওয়া পর্যন্ত কাউন্টার হাইড রাখার জন্য
  useEffect(() => {
    setMounted(true);
  }, []);
          ...
          <div className="absolute left-1/2 -translate-x-1/2 md:static md:translate-x-0 flex flex-col items-center flex-shrink-0">
            ...
            >
              <div className="flex items-center justify-center space-x-[-8px] md:space-x-[-10px] scale-[0.85] md:scale-100">
                <div className="h-9 w-9 md:h-10 md:w-10 rounded-full bg-pink-100 flex items-center justify-center border border-pink-200 text-xs font-bold text-black">
                  M
                </div>
                ...
                <div className="h-9 w-9 md:h-10 md:w-10 rounded-full bg-pink-200 flex items-center justify-center border border-pink-300 text-xs text-black font-bold">
                  A
                </div>
              </div>
            ...
            >
              ...
              <div className="flex flex-col text-white font-medium">
                <Link
                  href="/terms"
                  onClick={() => setIsOpen(false)}
                  className="px-6 py-4 border-b border-white/10 hover:bg-white/10 transition-colors"
                >
                  Terms & Conditions
                </Link>
                <Link
