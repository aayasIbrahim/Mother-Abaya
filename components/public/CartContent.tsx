...
export default function CartContent({
  ...
  if (!mounted)
    return <div className="animate-pulse h-96 bg-white rounded-sm" />;

  const subtotal = getTotalPrice();
  const isCartEmpty = cart.length === 0;

  // সার্ভার থেকে আসা চার্জ ব্যবহার
  const estimatedShipping = isCartEmpty ? 0 : shippingRates.insideDhaka;
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    {!isCartEmpty && (
                      <div className="flex flex-col items-end">
                        ...
                        <p className="text-[10px] text-gray-400 mt-1 max-w-[160px] leading-tight italic">
                          * For Outside Dhaka, it will be
