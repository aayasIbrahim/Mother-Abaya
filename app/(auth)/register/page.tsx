    ...
    <main className="min-h-screen bg-[#FDF7FB] flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-[500px] bg-white rounded-[2.5rem] shadow-2xl shadow-pink-100/50 overflow-hidden border border-white">
        ...
        <div className="bg-[#B3589D] p-10 text-center text-white">
          ...
          <p className="text-pink-100 text-sm font-medium">Join Mother Abaya family today</p>
        </div>
        ...
        <div className="p-8 md:p-10">
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center gap-2 ml-1 py-2">
              <input type="checkbox" className="w-4 h-4 accent-[#B3589D]" id="terms" />
              <label htmlFor="terms" className="text-xs text-gray-500 font-medium">
                I agree to the <Link href="/terms-and-conditions" className="text-[#B3589D] font-bold hover:underline">Terms</Link> & <Link href="/privacy-policy" className="text-[#B3589D] font-bold hover:underline">Privacy Policy</Link>
              </label>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-500 text-sm font-medium">
              ...
              <Link href="/login" className="text-[#B3589D] font-black hover:underline underline-offset-4">
                Login Now
              </Link>
            </p>
          </div>
