    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-col items-center md:items-end">
          <span className="text-[10px] font-black uppercase text-gray-400 mb-1 tracking-widest">
            Current Status
          </span>
              ...
              {order.items.map((item: any) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-bold uppercase text-gray-800 leading-tight">
                      {item.name}
                    </h4>
          ...
          <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm font-bold uppercase text-gray-900 mt-0.5">
                  {order.customer.name}
                </p>
              </div>
