...
const TermsPage = () => {
  ...
  const content = {
    en: {
      ...
      brand: "Mother Abaya",
      intro:
        "Welcome to Mother Abaya! Please review our policies carefully to ensure a smooth shopping experience.",
      items: [
        {
          t: "1. Delivery Timeline",
          d: "In-stock items are delivered within 5-7 days. Pre-order items may take 10-20 days.",
        },
        {
          t: "2. Refund Policy",
          d: "We offer exchanges for issues. If unavailable, refunds are processed within 5-10 days.",
        },
        {
          t: "3. Return Policy",
          d: "Please inspect products upon delivery. Complaints are not accepted once the courier leaves.",
        },
        {
          t: "4. Data Privacy",
          d: "Your personal information is secure. We never share your data with third parties.",
        },
      ],
    ...
    bn: {
      ...
      brand: "মাদার আবায়া",
      intro:
        "মাদার আবায়াতে স্বাগতম! আমাদের পরিষেবাগুলো সম্পর্কে বিস্তারিত জানতে নিচের শর্তাবলী পড়ুন।",
      items: [
        {
          t: "১. ডেলিভারি সময়সীমা",
          d: "স্টকে থাকা পণ্য ৫-৭ দিন। প্রি-অর্ডার পণ্য ডেলিভারিতে ১০-২০ দিন সময় লাগতে পারে।",
        },
        {
          t: "২. রিফান্ড পলিসি",
          d: "পণ্য এক্সচেঞ্জ সুবিধা রয়েছে। এক্সচেঞ্জ সম্ভব না হলে ৫-১০ দিনে রিফান্ড করা হয়।",
        },
        {
          t: "৩. রিটার্ন পলিসি",
          d: "ডেলিভারি ম্যানের সামনে পণ্য চেক করুন। ডেলিভারি সম্পন্ন হওয়ার পর কোনো অভিযোগ গ্রহণযোগ্য নয়।",
        },
        {
          t: "৪. তথ্য সুরক্ষা",
          d: "আপনার সকল ব্যক্তিগত তথ্য আমাদের কাছে নিরাপদ। আমরা কোনো তথ্য তৃতীয় পক্ষের কাছে শেয়ার করি না।",
        },
      ],
    ...
    ar: {
      ...
      brand: "مذر عباية",
      intro:
        "مرحباً بكم في مذر عباية! يرجى مراجعة سياساتنا بعناية لضمان تجربة تسوق سلسة.",
      items: [
        {
          t: "١. جدول التسليم",
          d: "يتم تسليم المنتجات المتوفرة خلال ٥-٧ أيام. قد تستغرق الطلبات المسبقة ١٠-٢٠ يوماً.",
        },
        {
          t: "٢. سياسة الاسترداد",
          d: "نحن نقدم خدمة الاستبدال. إذا لم يكن ذلك ممكناً، فسيتم رد المبلغ خلال ٥-١٠ أيام.",
        },
        {
          t: "٣. سياسة الإرجاع",
          d: "يرجى فحص المنتجات عند التسليم. لا يتم قبول الشكاوى بمجرد مغادرة مندوب التوصيل.",
        },
        {
          t: "٤. خصوصية البيانات",
          d: "معلوماتك الشخصية آمنة معنا. نحن لا نشارك بياناتك مع أطراف ثالثة أبداً.",
        },
      ],
      ...
      <div className="container mx-auto px-4 -mt-12">
        <div className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-2xl shadow-pink-100/50 overflow-hidden border border-white">
          ...
          >
            {/* Header section */}
            <div
              className={`flex flex-col ${activeTab === "ar" ? "items-start" : "items-start"} gap-4 mb-10`}
            >
            ...
            <div className="grid gap-6">
              {content[activeTab as keyof typeof content].items.map(
                (item, i) => (
                  <div
                    key={i}
                  ...
                  >
                    <div
                      className={`flex ${activeTab === "ar" ? "flex-row-reverse" : "flex-row"} items-start gap-5`}
                    >
