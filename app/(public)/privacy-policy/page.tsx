...
const PrivacyPolicy = () => {
  ...
  const content = {
    en: {
      ...
      brand: "Mother Abaya",
      intro:
        "Thank you for visiting Mother Abaya. We are committed to safeguarding your privacy and ensuring your personal information remains secure.",
      sections: [
        {
    ...
    bn: {
      ...
      brand: "মাদার আবায়া",
      intro:
        "মাদার আবায়া ভিজিট করার জন্য ধন্যবাদ। আমরা আপনার গোপনীয়তা রক্ষা করতে এবং আপনার ব্যক্তিগত তথ্য সুরক্ষিত রাখতে প্রতিশ্রুতিবদ্ধ।",
      sections: [
        {
      ...
      footer:
        "আমাদের ওয়েবসাইট ব্যবহার করার মাধ্যমে, আপনি এই গোপনীয়তা নীতিতে বর্ণিত অনুশীলনের সাথে সম্মত হন।",
    },
    ar: {
      title: "سياسة الخصوصية",
      brand: "مذر عباية",
      intro:
        "شكرًا لزيارتكم مذر عباية. نحن ملتزمون بحماية خصوصيتكم وضمان بقاء معلوماتكم الشخصية آمنة.",
      sections: [
        {
      ...
      footer:
        "باستخدام موقعنا، فإنك توافق على الممارسات الموضحة في سياسة الخصوصية هذه.",
    },
  };
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-2xl shadow-pink-100/50 overflow-hidden border border-white">
            ...
            {["en", "bn", "ar"].map((lang) => (
              <button
                ...
                className={`flex-1 py-4 rounded-2xl font-bold transition-all ${
                  activeTab === lang
                    ? "bg-[#B3589D] text-white shadow-lg"
          ...
          >
            ...
            <div className="space-y-12">
              {content[activeTab as keyof typeof content].sections.map(
                (section, idx) => (
                  <div
                    key={idx}
                    className="bg-gray-50/50 p-8 rounded-[2rem] border border-gray-100"
                  >
                    <div
                      className={`flex items-center gap-4 mb-6 ${activeTab === "ar" ? "flex-row-reverse" : "flex-row"}`}
                    >
                    ...
                    <ul className="space-y-4">
                      {section.items.map((item, i) => (
                        <li
                          key={i}
                          className={`flex gap-4 text-gray-600 text-lg leading-relaxed ${activeTab === "ar" ? "flex-row-reverse" : "flex-row"}`}
                        >
