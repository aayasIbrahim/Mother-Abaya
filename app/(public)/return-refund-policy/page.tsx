...
const ReturnRefundPage = () => {
  ...
  const content = {
    en: {
      ...
      brand: "Mother Abaya",
      intro:
        "We value our customers and strive to provide the best shopping experience. Our policy ensures a smooth process for any issues with your purchase.",
      sections: [
        {
          title: "Return Policy",
      ...
      footer:
        "Feel free to contact us via the numbers provided on your invoice or our Facebook page.",
    },
    bn: {
      title: "রিটার্ন এবং রিফান্ড পলিসি",
      brand: "মাদার আবায়া",
      intro:
        "আমরা আমাদের গ্রাহকদের মূল্যায়ন করি এবং সেরা কেনাকাটার অভিজ্ঞতা দেওয়ার চেষ্টা করি।",
      sections: [
        {
          title: "রিটার্ন পলিসি",
          icon: <RefreshCcw className="text-[#B3589D]" />,
      ...
      footer:
        "আপনার ইনভয়েসে দেওয়া নাম্বারে বা আমাদের ফেসবুক পেজের মাধ্যমে যোগাযোগ করুন।",
    },
    ar: {
      title: "سياسة الإرجاع والاسترداد",
      brand: "مذر عباية",
      intro:
        "نحن نقدر عملائنا ونسعى لتقديم أفضل تجربة تسوق. تضمن سياستنا عملية سلسة لأي مشاكل في مشترياتك.",
      sections: [
        {
          title: "سياسة الإرجاع",
          icon: <RefreshCcw className="text-[#B3589D]" />,
      ...
      footer:
        "لا تتردد في الاتصال بنا عبر الأرقام الموضحة في فاتورتك أو صفحتنا على الفيسبوك.",
    },
  };
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-2xl shadow-pink-100/50 overflow-hidden border border-white">
          ...
          >
                  ...
                  >
                    ...
                    <ul className="space-y-4">
                      {section.items.map((item, i) => (
                        <li
                          key={i}
                          className="flex gap-4 text-gray-600 text-lg leading-relaxed"
                        >
            ...
            <div className="mt-16 pt-8 border-t border-dashed text-center">
              <div className="text-[#B3589D] font-black text-2xl mb-2">
